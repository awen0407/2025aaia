...
// 修改自 week10_1_bubble_happy_part2(可在GitHub 2025aaia整個下載zip)
PImage happy1, happy2, happy3; // 第三張圖 
PImage [] happy = new PImage[200]; // 200張小圖片 java陣列宣告, 有200格
int N = 0;
int [] x = new int[200]; // 200 個 x 座標
int [] y = new int[200]; // 200 個 y 座標
void setup(){
  size(600,675); // 大小和圖片一樣ㄛ
  happy1 = loadImage("happy1.jpg");
  happy2 = loadImage("happy2.jpg");
}
void mousePressed(){ // 每次mouse按下去,就變一張小圖
